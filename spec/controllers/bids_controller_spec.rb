...
RSpec.describe BidsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested bid as @bid" do
      bid = Bid.create! valid_attributes
      get :show, params: {id: bid.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested bid as @bid" do
      bid = Bid.create! valid_attributes
      get :edit, params: {id: bid.to_param}, session: valid_session
      expect(assigns(:bid)).to eq(bid)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Bid" do
        expect {
          post :create, params: {bid: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved bid as @bid" do
        post :create, params: {bid: invalid_attributes}, session: valid_session
        expect(assigns(:bid)).to be_a_new(Bid)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested bid" do
        bid = Bid.create! valid_attributes
        put :update, params: {id: bid.to_param, bid: new_attributes}, session: valid_session
        bid.reload
      ...
      it "assigns the requested bid as @bid" do
        bid = Bid.create! valid_attributes
        put :update, params: {id: bid.to_param, bid: valid_attributes}, session: valid_session
        expect(assigns(:bid)).to eq(bid)
      end
    ...
    context "with invalid params" do
      it "assigns the bid as @bid" do
        bid = Bid.create! valid_attributes
        put :update, params: {id: bid.to_param, bid: invalid_attributes}, session: valid_session
        expect(assigns(:bid)).to eq(bid)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested bid" do
      bid = Bid.create! valid_attributes
      expect {
        delete :destroy, params: {id: bid.to_param}, session: valid_session
      }.to change(Bid, :count).by(-1)
    end
